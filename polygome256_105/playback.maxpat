	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numinlets" : 2,
					"patching_rect" : [ 212.0, 816.0, 27.0, 17.0 ],
					"id" : "obj-1",
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numinlets" : 1,
					"patching_rect" : [ 195.0, 749.0, 62.0, 17.0 ],
					"id" : "obj-2",
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numinlets" : 2,
					"patching_rect" : [ 202.0, 719.0, 43.0, 17.0 ],
					"id" : "obj-3",
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numinlets" : 2,
					"patching_rect" : [ 239.0, 696.0, 32.0, 17.0 ],
					"id" : "obj-4",
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"fontname" : "Arial"
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"fontsize" : 9.0,
									"numinlets" : 2,
									"patching_rect" : [ 136.0, 310.0, 16.0, 15.0 ],
									"id" : "obj-1",
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Arial"
...
, 							{
								"box" : 								{
									...
									"fontsize" : 9.0,
									"numinlets" : 0,
									"patching_rect" : [ 138.0, 275.0, 31.0, 17.0 ],
									"id" : "obj-2",
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numinlets" : 2,
					"patching_rect" : [ 408.0, 543.0, 34.0, 17.0 ],
					"id" : "obj-38",
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numinlets" : 1,
					"patching_rect" : [ 747.0, 441.0, 89.0, 17.0 ],
					"id" : "obj-66",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "expr abs($i1-16)*15",
					"fontsize" : 9.0,
					"numinlets" : 1,
					"patching_rect" : [ 780.0, 292.0, 108.0, 17.0 ],
					"id" : "obj-68",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numinlets" : 4,
					"patching_rect" : [ 277.0, 905.0, 91.0, 17.0 ],
					"id" : "obj-74",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
